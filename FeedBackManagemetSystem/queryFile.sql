...
CREATE TABLE  "TRAINING_PROGRAM" 
   (	"TRAINING_CODE" NUMBER(5,0), 
	"COURSE_CODE" NUMBER(5,0) REFERENCES COURSE_MASTER(COURSE_ID), 
	"FACULTY_CODE" NUMBER(5,0) REFERENCES EMPLOYEE_MASTER(EMPLOYEE_ID), 
	"START_DATE" DATE, 
	"END_DATE" DATE, 
	 PRIMARY KEY ("TRAINING_CODE") ENABLE
   ) ;
